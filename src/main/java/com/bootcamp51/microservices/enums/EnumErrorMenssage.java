package com.bootcamp51.microservices.enums;
...
public enum EnumErrorMenssage {
    ...
    ERROR1009("1008","The type client requires a minimum of a Current account and a credit card."),
    ERROR1010("1009","Minimum amount of the savings account must be 500 soles.")
